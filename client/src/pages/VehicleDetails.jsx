...
function VehicleDetails() {
  ...
  if (!vehicle) return <p className="text-center py-6">Loading vehicle details...</p>;
  ...
  return (
    <MainLayout>
      ...
      <div className="grid grid-cols-2 gap-4 text-sm text-gray-700 dark:text-gray-200">
        ...
        <p><strong>Price/Day:</strong> ₹{vehicle.pricePerDay || vehicle.price}</p>
        <p><strong>Status:</strong> {vehicle.available ? "Available" : "Unavailable"}</p>
      </div>
